var NepaliFunctions = (function () {
    ...
    function i(e, t) {
        return (
            "string" == typeof e && (e = u(e, (t = a(t)))) && (e.format = t), e
        );
    }
    function o(e) {
    ...
    return {
        ...
        ParseDate: function (e) {
            ...
            if (t) {
                var a = e.split("/");
                3 == a.length &&
                    ((r = o(a)).parsedFormat = r.parsedFormat.join("/"));
            } else if (n) {
                var i = e.split("-");
                3 == i.length &&
                    ((r = o(i)).parsedFormat = r.parsedFormat.join("-"));
            }
            function o(e) {
                var t = {},
                    n = [],
        ...
        BsAddDays: function (e, t, n) {
            ...
            return (
                (r = new Date(r.year, r.month - 1, r.day)).setDate(
                    r.getDate() + t
                ),
                (r = {
                    year: r.getFullYear(),
        ...
        GetAdFullDate: function (e, t) {
            return (e = i(e, t))
                ? `${e.day} ${NepaliFunctions.GetAdMonth(e.month - 1)} ${
                      e.year
                  }`
                : null;
        },
        ...
        NumberToWords: function (e, t) {
            if (
                ((e = e || 0), isNaN(e) || Math.floor(e).toString().length > 13)
            )
                return null;
            var n = "",
                r = 0,
...
!(function () {
                ...
                (function (e) {
                    var t = (function (e) {
                                ...
                                (n += (function (e) {
                                    ...
                                    for (; e; )
                                        (t += e.offsetLeft),
                                            (e = e.offsetParent);
                                    return (t +=
                                        document.firstChild.offsetLeft || 0);
                                })(e)),
                                (r += (function (e) {
                                    var t = 0;
                                    for (; e; )
                                        (t += e.offsetTop),
                                            (e = e.offsetParent);
                                    return (t +=
                                        document.firstChild.offsetTop || 0);
                                })(e)),
                                { x: n, y: r }
                            );
                        })(e),
                        ...
                        r = (function (e, t) {
                            ...
                            return (
                                window.innerHeight - t.y - e.offsetHeight + n
                            );
                        })(e, t),
    ...
    function d(e, t, n, r) {
        ...
        (b.innerHTML = u ? e : NepaliFunctions.ConvertToUnicode(e)),
            o.ndpMonth && o.ndpYear
                ? (p.appendChild(s(t, e, n, r)),
                  p.appendChild(c(t, e, h, n, r)))
                : o.ndpMonth
                ? (p.appendChild(s(t, e, n, r)),
                  p.appendChild(y),
                  p.appendChild(b))
        ...
        w.setAttribute("id", "next" + a),
            ...
            i.getElementsByTagName("table")[0].insertAdjacentElement(
                ...
                (function (e, t, n, r) {
                    ...
                    if (n) {
                        var s = NepaliFunctions.ConvertToDateObject(
                            n,
                            "YYYY-MM-DD"
                        );
                    ...
                    for (; B < Y; ) {
                        if (
                            ...
                            if (
                                ((I =
                                    document.createElement("TD")).setAttribute(
                                    "class",
                                    C
                                ),
                                (u.disableAfter &&
                                    NepaliFunctions.CompareBsDates(
                                        NepaliFunctions.ConvertToDateObject(
                                            F,
                                            "YYYY-MM-DD"
                                        ),
                                        u.disableAfter
                                ...
                                var w = NepaliFunctions.ConvertToDateObject(
                                        F,
                                        "YYYY-MM-DD"
                                    ),
                                    G = NepaliFunctions.ConvertDateFormat(
                                        w,
                                        u.dateFormat
                                    );
                                (x = document.createElement("A")).setAttribute(
    ...
    function s(e, t, n, r) {
        ...
        var i = m(),
            ...
            l = 12;
        i.disableBefore &&
            i.disableBefore.year == t &&
            (u = i.disableBefore.month),
            i.disableAfter &&
                i.disableAfter.year == t &&
                (l = i.disableAfter.month);
        var s = o
        ...
        return (
            ...
            c.addEventListener("change", function () {
                !(function (e, t, n) {
                    ...
                    e = a.ndpYear
                        ? parseInt(
                              document.getElementById("ndp-year-select" + r)
                                  .value
                          )
                        : e;
                    var i = parseInt(
    ...
    function c(e, t, n, r, a) {
        ...
        var o = m(a),
            ...
            s = 2099;
        o.disableBefore &&
            o.disableBefore.year > l &&
            (l = o.disableBefore.year),
            o.disableAfter &&
                o.disableAfter.year < s &&
                (s = o.disableAfter.year);
        var c = document.createElement("SELECT");
        c.setAttribute("id", "ndp-year-select" + i);
        for (
            var f =
                    Math.round(n / 2) > 0 &&
                    parseInt(t) - Math.round(n / 2) >= l
                        ? parseInt(t) - Math.round(n / 2)
                        : l,
                h =
                    Math.round(n / 2) > 0 &&
                    parseInt(t) + Math.round(n / 2) <= s
                        ? parseInt(t) + Math.round(n / 2)
                        : s;
            f <= h;
